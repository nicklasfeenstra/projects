...
module.exports = ":host {\r\n    display: flex;\r\n    flex-direction: column;\r\n    position: absolute;\r\n    top: 0;\r\n    bottom: 0;\r\n    left: 0;\r\n    right: 0;\r\n    background: linear-gradient(to bottom, #033885 0%,#023785 25%, #154d9a 50%, #245fac 75%);\r\n  }"
...
var MessageComponent = /** @class */ (function () {
    ...
    MessageComponent.prototype.getMessage = function () {
        var _this = this;
        this.messageService.getMessage().subscribe(function (response) { return _this.title = response.message; });
    };
...
module.exports = "<mat-sidenav-container class=\"sidenav-container dark-theme\">\n  <mat-sidenav #drawer class=\"sidenav\" fixedInViewport=\"true\" [attr.role]=\"(isHandset$ | async) ? 'dialog' : 'navigation'\"\n    [mode]=\"(isHandset$ | async) ? 'over' : 'push'\" [opened]=\"!(isHandset$ | async)\">\n    <mat-toolbar color=\"primary\">Menu</mat-toolbar>\n    <mat-nav-list>\n      <a mat-list-item href=\"#\">Link 1</a>\n      <a mat-list-item href=\"#\">Link 2</a>\n      <a mat-list-item href=\"#\">Link 3</a>\n    </mat-nav-list>\n  </mat-sidenav>\n  <mat-sidenav-content>\n    <mat-toolbar color=\"primary\">\n      <button type=\"button\" aria-label=\"Toggle sidenav\" mat-icon-button (click)=\"drawer.toggle()\">\n        <mat-icon aria-label=\"Side nav toggle icon\">menu</mat-icon>\n      </button>\n    </mat-toolbar>\n    <!-- Add Content Here -->\n  </mat-sidenav-content>\n</mat-sidenav-container>"
...
module.exports = __webpack_require__(/*! C:\Users\Nicklas\git\projects\client\src\main.ts */"./src/main.ts");
